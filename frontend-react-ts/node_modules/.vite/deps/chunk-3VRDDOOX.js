...
var fromBase64 = (input) => {
  ...
  for (let i = 0; i < input.length; i += 4) {
    ...
    for (let k = 0; k < byteLength; k++) {
      ...
      dataView3.setUint8(chunkOffset + k, (bits & 255 << offset) >> offset);
    }
  }
...
var HttpProtocol = class extends SerdeContext {
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./event-streams-AYJLLHI7.js");
...
//# sourceMappingURL=chunk-3VRDDOOX.js.map
